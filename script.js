const i18n = {
  ko: {
    ...
    visionTitle: "비전",
    visionText: "“우리는 <strong>근본 원리 탐구</strong>와 <strong>현실 문제 해결</strong>을 동시에 추구하며, 재현 가능한 방법과 개방형 협업으로 <strong>초지능화</strong> 시대에 학문과 산업의 <strong>프런티어</strong>를 확장한다.”",
  ...
  en: {
    ...
    visionTitle: "Vision",
    visionText: "“We pursue both <strong>fundamental principles</strong> and <strong>real-world solutions</strong>, extending the <strong>frontier</strong> of academia and industry through reproducible methods and open collaboration in the era of <strong>super intelligence</strong>.”",
