const i18n = {
  ko: {
    ...
    heroTitle: "난제에 도전하고, <span class='accent'>양자 도약</span>을 이끕니다",
    ...
    focus2Title: "데이터·AI 시스템", focus2Body: "신뢰 가능한 생성형 AI, 자율 에이전트, 설명 가능한 모델과 운영 자동화.",
    focus3Title: "금융·리스크 과학", focus3Body: "포트폴리오 최적화, 시계열·미시구조 분석, 알고리즘 트레이딩 연구.",
  ...
  en: {
    ...
    focus2Title: "Data & AI Systems", focus2Body: "Trustworthy generative AI, autonomous agents, explainable models, and operational automation.",
    focus3Title: "Financial & Risk Science", focus3Body: "Portfolio optimization, time-series and microstructure analysis, algorithmic trading research.",
